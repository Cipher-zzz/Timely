...
class CoreDataController: NSObject, DatabaseProtocol, NSFetchedResultsControllerDelegate{
    ...
    func createDefaultEntries() {
        ...
        let _ = addTask(newTaskTitle: "task3", newTaskDescription: "desc3", newTaskDueDate: Date().add(component: .hour, value: 3), newTaskStartDate: Date().add(component: .hour, value: 4), newTaskAddress: "Melbourne Airport", newTaskRepeat: false, newTaskHasBeenCompleted: false)
